...
### Четвертый этап. Сервис (чекпоинт 5)

Улучшили модель при помощи замены базовой модели stable-diffusion-v1-5/stable-diffusion-v1-5 на специально дообученную под генерацию в стиле аниме модель dreamlike-art/dreamlike-anime-1.0.

### Пятый этап. Сервис (чекпоинт 6)

Еще улучшили метрики и качество изображений, обучив более сильную версию IP-Adapter - IP-Adapter Plus.

- Пример обучения и применения модели в файле  [ip_adapter_plus_demo.ipynb](./ip_adapter_plus_demo.ipynb)
- Скрипт с подсчетом метрик в [ip_adapter_metrics.ipynb](./ip_adapter_metrics.ipynb)
- Сравнение моделей и метрик в файле [models_comparison.md](./models_comparison.md)
